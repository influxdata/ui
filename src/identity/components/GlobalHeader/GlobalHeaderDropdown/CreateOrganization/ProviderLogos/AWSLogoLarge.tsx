...
import './AWSLogoLarge.scss'

interface Props {
  className?: string
}

export const AWSLogoLarge: FC<Props> = ({className}) => {
  ...
  return (
    ...
    >
      <path
        className="b"
        d="M86.4,66.4c0,3.7,0.4,6.7,1.1,8.9c0.8,2.2,1.8,4.6,3.2,7.2c0.5,0.8,0.7,1.6,0.7,2.3c0,1-0.6,2-1.9,3L83.2,92
