...
export const InitializeTokenClient: FC<OwnProps> = ({
  ...
  const bucketSnippet = `influx bucket create sample-bucket -c onboarding`
  ...
  return (
    <>
      ...
      <h2 style={{marginTop: '48px', marginBottom: '0px'}}>Create a Token</h2>
      <p style={{marginTop: '8px', marginBottom: '8px'}}>
        First we'll create a token. A <b>token</b> is used to authenticate API
        access.
      </p>
      <CodeSnippet
