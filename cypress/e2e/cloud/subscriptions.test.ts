...
describe('Subscriptions', () => {
  ...
  const createBasicLPSubscription = (name: string) => {
    ...
    cy.getByTestID('create-sub-form--submit')
      .should('be.visible')
      .click()
  ...
  it('should create, update, stop, start and delete LP subscription', () => {
    ...
    cy.getByTestID('update-subscription-form--bucket').scrollIntoView().should('be.visible').contains('defbuck')
    ...
    cy.get('.subscription-details-page__status--RUNNING')
      .should('be.visible')
      .contains('RUNNING')
    cy.getByTestID('update-sub-form--cancel')
      .should('be.visible')
      .click()
  ...
  it('should create, update, stop, start and delete a JSON subscription', () => {
    ...
    cy.getByTestID('true-json-delete-label--button')
      .first()
      .click()
  ...
  it('should create, update, stop, start and delete a String subscription', () => {
    ...
    cy.getByTestID('Tag-string-delete-label--button')
      .first()
      .click()
