...
export const CREDIT_250_EXPERIENCE_CUTOFF_EPOCH = 1646697600000 // 8 March 2022

export const INFLUXDATA_SUPPORT_CONTACT_UK = '+44 808-196-6148'
export const INFLUXDATA_SUPPORT_CONTACT_UK_NO_SPACE = 'tel:+448081966148'
export const INFLUXDATA_SUPPORT_CONTACT_US = '+1 855-958-1047'
export const INFLUXDATA_SUPPORT_CONTACT_US_NO_SPACE = 'tel:+18559581047'
