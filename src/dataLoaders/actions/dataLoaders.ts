...
export type Action =
  ...
  | AddPluginBundle
  | AddTelegraf_telegrafUiRefresh
  | AddTelegrafPlugins_telegrafUiRefresh
  | AddTelegrafPlugins
  | RemoveBundlePlugins
  | RemovePluginBundle
...
interface AddTelegraf_telegrafUiRefresh {
...
interface AddTelegrafPlugins_telegrafUiRefresh {
