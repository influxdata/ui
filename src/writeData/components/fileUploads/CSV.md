For more detailed and up to date information check out the [CLI CSV Documentation](https://docs.influxdata.com/influxdb/cloud/write-data/developer-tools/csv/)
