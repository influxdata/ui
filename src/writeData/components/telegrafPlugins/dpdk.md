...
The [plugin collecting interval](https://github.com/influxdata/telegraf/tree/master/docs/CONFIGURATION.md#input-plugins)
...
tags](https://github.com/influxdata/telegraf/tree/master/docs/CONFIGURATION.md#input-plugins) to input plugin's
measurements.
...
JSON Flattener](https://github.com/influxdata/telegraf/tree/master/plugins/parsers/json/README.md) and exposed as fields.  If DPDK
