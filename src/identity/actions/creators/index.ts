...
export const CLEAR_QUARTZ_IDENTITY = 'CLEAR_QUARTZ_IDENTITY'
...
export type Actions =
  ...
  | ReturnType<typeof clearQuartzIdentity>
...
export const clearQuartzIdentity = () =>
  ({
    type: CLEAR_QUARTZ_IDENTITY,
  } as const)
