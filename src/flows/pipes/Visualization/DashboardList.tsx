...
const DashboardList: FC<Props> = ({
  ...
  const nameInput = isEditingName && (
    <div className="flow-visualization--dashboard-list-section">
      <InputLabel className="flow-visualization--dashboard-list-label">
        New Dashboard Name
      </InputLabel>
      <Input
        type={InputType.Text}
  ...
  return (
    <div className="flow-visualization--dashboard-list">
      ...
      <FlexBox
        ...
        className="flow-visualization--dashboard-list-section"
      >
        <SquareButton
